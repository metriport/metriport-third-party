...
2. Add or update the patient's address (typically done during initial patient setup)
3. The Metriport Patient Created Protocol will automatically send a webhook to Metriport that will create the patient in the background and fetch their medical data for immediate availability in the Metriport App
...
- (Optional) Metriport Plugin Token - if you'd like to receive ADT events for specific patient
